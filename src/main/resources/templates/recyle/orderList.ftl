    ...
    <div class="aui-card-list-content-padded">
        <div class="aui-row aui-row-padded">
            ...
            <div class="aui-col-xs-8">
                <div class="aui-col-xs-12">回收方式:xxxxxxx</div>

                <div class="aui-col-xs-12 aui-ellipsis-1 ">估价金额:xsdas(用户测评价格) </div>
                <div class="aui-col-xs-12">联系人:xsdas </div>
                <div class="aui-col-xs-12 aui-ellipsis-1 ">联系方式:xsdas </div>
